...
class categoryView  extends applicationsSuperView
{
	...
	public function displayProductByCategoryTemplate()
	{
		...
		$productBlockController = new productsBlockController();
		
		$content = $productBlockController->renderProductListingTemplate($this->products);
		response::getInstance()->addContentToTree(array('APPLICATION_CONTENT'=>$content));
	}
